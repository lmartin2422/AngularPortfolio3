...
export class ProjectsService {  //COMPLETE THIS WITH REAL VALUES
  ...
  projects: Project[] = [
    ...
    { id: 4, name: 'Sales Lead Tracker Chrome Extension', pictures:[" "], project_link: "https://github.com/lmartin2422/ChromeExtension", summary: 'Created a chrome extension to store Sales Leads', description: 'Developed a chrome extension that allows a salesperson to save and delete a website that is a sales lead.  The website for the sales lead is saved by clicking the “Save” button.  It then displays all the previously saved sales leads which are hyperlinks.  The sales person can also “Delete” the leads by clicking the “Delete” button.',  tags: [Tag.JAVASCRIPT, Tag.HTML]},
    { id: 5, name: 'Rest API', pictures:[" "], project_link: "https://github.com/lmartin2422/REST_API", summary: 'CRUD Operations and HTTP Methods & Requests', description: 'REST APIs are very popular so I decided to makes one!',  tags: [Tag.JAVASCRIPT,Tag.EXPRESSJS, Tag.NODEJS ]},
