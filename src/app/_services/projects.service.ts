...
export class ProjectsService {  //COMPLETE THIS WITH REAL VALUES
  ...
  projects: Project[] = [
    ...
    { id: 5, name: 'Rest API', pictures:["../../assets/restAPI.png "], project_link: "https://github.com/lmartin2422/REST_API", summary: 'CRUD Operations and HTTP Methods & Requests', description: 'REST APIs are very popular so I decided to makes one!',  tags: [Tag.JAVASCRIPT,Tag.EXPRESSJS, Tag.NODEJS ]},
    ...
    { id: 7, name: 'Home/Office Network Set Up', pictures:[" "], project_link: "Building a simulation of networks ", summary: '', description: 'Using Cisco Packet Tracer, I built a home network and an office network in a simulated environment. This project demonstrates my knowledge of network devices, IP configuration, and network set ups.', tags: [ ] },
];
